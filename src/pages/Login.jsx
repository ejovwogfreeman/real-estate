...
const Login = () => {
  ...
  return (
    ...
    <div className='w-full h-full absolute blur  contrast-[0.4]' style={{
    ...
    <div className='w-full h-full z-10 relative flex flex-row justify-center items-center'>
        <div className='content flex flex-col items-center -mt-20'>
            ...
            <div className='flex bg-white justify-between items-center py-3 px-4 rounded-lg w-full mt-5'>
                <input className='appearance-none text-xl' name='password' placeholder='Enter Password' type='password'/>
                <span>
            ...
            <div className='relative mt-10 flex flex-row justify-center'>
                <button onClick={() => navigate('/find-apartment/search')} className='px-12 py-2 border-4 text-xl text-white border-white rounded-full uppercase' type='button'> Login </button>
            </div>
        </div>
    </div>
</div>
