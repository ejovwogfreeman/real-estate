...
const FindApartmentSearch = () => {
    const [selectArea, setSelectArea] = useState('Preleasing Open to Corporate tenants')
        ...
        <div className='content flex flex-col items-center -mt-20'>
            ...
            <div className='relative'>
                ...
                <div className='relative mt-10 flex flex-row justify-center'>
                    <button onClick={() => navigate('/find-apartment/detail')} className='px-5 py-2 border-4 text-xl text-white border-white rounded-full uppercase' type='button'> Join Waitlist</button>
                </div>
            </div>
        </div>
    </div>
