...
import './App.css';
import { Routes,  Route , Navigate, Outlet ,BrowserRouter, useSearchParams } from 'react-router-dom'
    ...
    <div  className={`${ showModal ? ' h-screen overflow-hidden': ''}`}>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route exact path ="/find-apartment/search" element={<FindApartmentSearch/>}/>
          <Route exact path ="/find-apartment/detail" element={<FindApartmentDetail 
          closeModal={closeModal}
          openModal={openModal}
          />}/>
          <Route exact path ="/find-apartment" element={<FindApartment/>}/>
          <Route exact path ="/recoa-communities" element={<Login/>}/>
          <Route exact path ="/corporate-tenant" element={<>corporate tenant</>}/>
        </Routes>
      </BrowserRouter>
    </div>
